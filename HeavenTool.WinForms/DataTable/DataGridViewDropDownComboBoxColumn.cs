...
public class DataGridViewDropDownComboBoxColumn : DataGridViewComboBoxColumn
{
    ...
    public override DataGridViewCell? CellTemplate
    {
        ...
        set
        {
            if ((value != null) && (value is not DataGridViewDropDownComboBoxCell))
            {
...
public class DataGridViewDropDownComboBoxCell : DataGridViewComboBoxCell
{
    ...
    protected override object GetFormattedValue(object? value, int rowIndex, ref DataGridViewCellStyle cellStyle, TypeConverter? valueTypeConverter, TypeConverter? formattedValueTypeConverter, DataGridViewDataErrorContexts context)
    {
        ...
        else
        {
            ...
            {
                DataGridViewDataErrorEventArgs dataGridViewDataErrorEventArgs = new(new FormatException("value must be a string"), ColumnIndex, rowIndex, context);
