...
{
    public class CheckedComboBox : DarkComboBox
    {
        /// <summary>
        ...
        internal class Dropdown : Form
        {
            ...
            internal class CustomCheckedListBox : CheckedListBox
            {
                ...
                {
                    if (Parent is Dropdown form) 
                    {
                        if (e.KeyCode == Keys.Enter)
                        {
                            // Enact selection.
                            form.OnDeactivate(new CCBoxEventArgs(null, true));
                            e.Handled = true;
                        ...
                        {
                            // Cancel selection.
                            form.OnDeactivate(new CCBoxEventArgs(null, false));
                            e.Handled = true;
                        }
                    }
