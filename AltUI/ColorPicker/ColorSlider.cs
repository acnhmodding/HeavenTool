...
namespace AltUI.ColorPicker
{
    ...
    public class ColorSlider : Control
    {
        ...
        {
            add => Events.AddHandler(_eventColor1Changed, value);
            remove => Events.RemoveHandler(_eventColor1Changed, value);
        }

        [Category("Property Changed")]
        public event EventHandler Color2Changed
        {
            add => Events.AddHandler(_eventColor2Changed, value);
            remove => Events.RemoveHandler(_eventColor2Changed, value);
        }

        [Category("Property Changed")]
        public event EventHandler Color3Changed
        {
            add => Events.AddHandler(_eventColor3Changed, value);
            remove => Events.RemoveHandler(_eventColor3Changed, value);
        }
        ...
        public event EventHandler NubOutlineColorChanged
        {
            add
            {
                Events.AddHandler(_eventNubOutlineColorChanged, value);
            }
            remove
            {
                Events.RemoveHandler(_eventNubOutlineColorChanged, value);
            }
        }
        ...
        protected virtual void OnColor1Changed(EventArgs e)
        {
            ...
            handler = (EventHandler)Events[_eventColor1Changed];
        ...
        protected virtual void OnColor2Changed(EventArgs e)
        {
            ...
            handler = (EventHandler)Events[_eventColor2Changed];
        ...
        protected virtual void OnColor3Changed(EventArgs e)
        {
            ...
            handler = (EventHandler)Events[_eventColor3Changed];
        ...
        protected virtual void OnCustomColorsChanged(EventArgs e)
        {
            ...
            handler = (EventHandler)Events[_eventCustomColorsChanged];
