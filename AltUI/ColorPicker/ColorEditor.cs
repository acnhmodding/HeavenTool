...
namespace AltUI.ColorPicker
{
    ...
    [ToolboxItem(true)]
    public sealed partial class ColorEditor : UserControl, IColorEditor
    {
        ...
        {
            add => Events.AddHandler(_eventNubColorChanged, value);
            remove => Events.RemoveHandler(_eventNubColorChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventNubOutlineColorChanged, value);
            remove => Events.RemoveHandler(_eventNubOutlineColorChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventPreserveAlphaChannelChanged, value);
            remove => Events.RemoveHandler(_eventPreserveAlphaChannelChanged, value);
        }

        [Category("Property Changed")]
        public event EventHandler ShowAlphaChannelChanged
        {
            add => Events.AddHandler(_eventShowAlphaChannelChanged, value);
            remove => Events.RemoveHandler(_eventShowAlphaChannelChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventShowColorSpaceLabelsChanged, value);
            remove => Events.RemoveHandler(_eventShowColorSpaceLabelsChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventShowHexChanged, value);
            remove => Events.RemoveHandler(_eventShowHexChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventShowHslChanged, value);
            remove => Events.RemoveHandler(_eventShowHslChanged, value);
        }
        ...
        {
            add => Events.AddHandler(_eventShowRgbChanged, value);
            remove => Events.RemoveHandler(_eventShowRgbChanged, value);
        }
        ...
        public bool PreserveAlphaChannel
        {
            ...
            set
            {
                if (_preserveAlphaChannel != value)
                {
                    ...
                    OnPreserveAlphaChannelChanged(EventArgs.Empty);
                }
            }
        }
        ...
        public bool ShowAlphaChannel
        {
            ...
            set
            {
                if (_showAlphaChannel != value)
                {
                    ...
                    OnShowAlphaChannelChanged(EventArgs.Empty);
                }
            }
        }
        ...
        public bool ShowColorSpaceLabels
        {
            ...
            set
            {
                if (_showColorSpaceLabels != value)
                {
                    ...
                    OnShowColorSpaceLabelsChanged(EventArgs.Empty);
                }
            }
        }
        ...
        public bool ShowHex
        {
            ...
            set
            {
                if (_showHex != value)
                {
                    ...
                    OnShowHexChanged(EventArgs.Empty);
                }
            }
        }
        ...
        public bool ShowHsl
        {
            ...
            set
            {
                if (_showHsl != value)
                {
                    ...
                    OnShowHslChanged(EventArgs.Empty);
                }
            }
        }
        ...
        public bool ShowRgb
        {
            ...
            set
            {
                if (_showRgb != value)
                {
                    ...
                    OnShowRgbChanged(EventArgs.Empty);
                }
            }
        }
        ...
        private void OnNubColorChanged(EventArgs e)
        {
            ...
            handler = (EventHandler)Events[_eventNubColorChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnNubOutlineColorChanged(EventArgs e)
        {
            EventHandler handler;

            UpdateSliderNubs();

            handler = (EventHandler)Events[_eventNubOutlineColorChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnPreserveAlphaChannelChanged(EventArgs e)
        {
            EventHandler handler;

            handler = (EventHandler)Events[_eventPreserveAlphaChannelChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnShowAlphaChannelChanged(EventArgs e)
        {
            EventHandler handler;
            ...
            handler = (EventHandler)Events[_eventShowAlphaChannelChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnShowColorSpaceLabelsChanged(EventArgs e)
        {
            EventHandler handler;
            ...
            handler = (EventHandler)Events[_eventShowColorSpaceLabelsChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnShowHexChanged(EventArgs e)
        {
            EventHandler handler;
            ...
            handler = (EventHandler)Events[_eventShowHexChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnShowHslChanged(EventArgs e)
        {
            EventHandler handler;
            ...
            handler = (EventHandler)Events[_eventShowHslChanged];
        ...
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        private void OnShowRgbChanged(EventArgs e)
        {
            EventHandler handler;
            ...
            handler = (EventHandler)Events[_eventShowRgbChanged];
        ...
        private void ResizeComponents()
        {
            try
            {
                ...
                top = padding.Top;
                innerMargin = 3;
                editWidth = TextRenderer.MeasureText("0000W", Font).Width + 6; // magic 6 for interior spacing+borders
                ...
                SetBarStates(barWidth >= _minimumBarWidth);
        ...
        {
            UpdateSliderNub(rColorBar);
            UpdateSliderNub(gColorBar);
            UpdateSliderNub(bColorBar);
            UpdateSliderNub(hColorBar);
            UpdateSliderNub(sColorBar);
            UpdateSliderNub(lColorBar);
            UpdateSliderNub(aColorBar);
        }
